...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    private String[] tileMap = {
        ...
        PacMan() {
           ...
           eatSound = loadSound("eat.wav");deathSound = loadSound("death.wav");gameOverSound = loadSound("gameOver.wav");
        ...
        public void loadMap () 
        {
            ...
            addPowerPellet(1, 1);
            addPowerPellet(1, columnCount - 2);
            addPowerPellet(rowCount - 2, 1);
            addPowerPellet(rowCount - 2, columnCount - 2);

            for (Block ghost : ghosts) {
                ghost.normalImage = ghost.image;
            }
        ...
        private void addPowerPellet(int row, int col) {
                int x = col * tileSize;
                int y = row * tileSize;
    ...
    clip.start();
        ...
        public void draw(Graphics g) {
            ...
            if (gameOver) {
                ...
                g.drawString("x" + String.valueOf(lives) + " Score: " + String.valueOf(score) + "Level: " + String.valueOf(level),  tileSize/2, tileSize/2);
            }
        ...
        public void move() {
            ...
            powerPellets.remove(palletEaten);
        ...
        public void levelUp() {
                level += 1;
                int newDelay = gameLoop.getDelay() - 5;
            if (newDelay < 20) {
                newDelay = 20; //speed cap so it doesn't become unplayable
    }
       ...
       @Override
        ...
        public void keyReleased(KeyEvent e) {
            if (gameOver) {
                ...
                ghostsScared = false;
                scaredTimer = 0;
                gameLoop.setDelay(50); //back to original speed
                gameOver = false;
                gameLoop.start();
            }
